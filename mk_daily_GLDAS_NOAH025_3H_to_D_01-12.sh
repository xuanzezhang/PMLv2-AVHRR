...
do
  ...
  do
     ...
     while [ $num -le 9 ]
     do
     ncea -O $inpath/$yr/0${iday}/GLDAS_NOAH025_3H.A${yr}010$num.*.nc4  $outpath/$yr/01/GLDAS_NOAH025_D.A${yr}010$num.020.nc4
     ncea -O $inpath/$yr/0${iday}/GLDAS_NOAH025_3H.A${yr}020$num.*.nc4  $outpath/$yr/02/GLDAS_NOAH025_D.A${yr}020$num.020.nc4
     ncea -O $inpath/$yr/0${iday}/GLDAS_NOAH025_3H.A${yr}030$num.*.nc4  $outpath/$yr/03/GLDAS_NOAH025_D.A${yr}030$num.020.nc4
     ...
     while [ $num -le 31 ]
     do
     ncea -O $inpath/$yr/0${iday}/GLDAS_NOAH025_3H.A${yr}01$num.*.nc4  $outpath/$yr/01/GLDAS_NOAH025_D.A${yr}01$num.020.nc4
     ncea -O $inpath/$yr/0${iday}/GLDAS_NOAH025_3H.A${yr}02$num.*.nc4  $outpath/$yr/02/GLDAS_NOAH025_D.A${yr}02$num.020.nc4
     ncea -O $inpath/$yr/0${iday}/GLDAS_NOAH025_3H.A${yr}03$num.*.nc4  $outpath/$yr/03/GLDAS_NOAH025_D.A${yr}03$num.020.nc4
