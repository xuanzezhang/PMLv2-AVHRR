...
WORKDIR=$ROOT/RUN_PML2.0_NCL_GLASS_LAI_15D_CASE01/
DRIVER=$WORKDIR/PMLV2-AVHRR-GLDAS-GLASS-LAI-15D-20200808.ncl
OUTDIR=$ROOT/OUTPUT_PMLV2.0_NCL/PML2.0_NCL_GLASS_LAI_15D_CASE01/
mkdir -p ${OUTDIR}
...
ln -sf $ROOT/AVHRR_Forcing_0.05deg/LAI_GLASS_0.05deg_15D .
  ...
  do
   # cp -p IGBP_MODIS_0.05deg/IGBP_MODIS_MCD12C1_Majority_Land_Cover_Type_1_${yr}_0.05deg.nc IGBP_Land_Cover_0.05deg.nc
    ...
    do
      ...
      ln -sf LAI_GLASS_0.05deg_15D/${yr}/GLASS01B02_V04_15D_A${yr}${month[i]}${half[j]}_0.05deg.nc GLASS_LAI_0.05deg.nc
      ncl $DRIVER 2>&1 >>log.${yr}.txt
      mv output_of_PMLV2.0_NCL_IGBP_GLDAS_AVHRR_15D.nc $OUTDIR/${yr}/output_of_PMLV2.0_IGBP_GLDAS_NOAH_AVHRR_GLASS_15D_A${yr}${month[i]}${half[j]}_0.05deg.nc
